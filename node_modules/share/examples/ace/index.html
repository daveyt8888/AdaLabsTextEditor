...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
	...
	<body>
		<div id="header">
			<div id="htext">
				<b>Editing</b> <input value="ace" id="namefield" type="text">
			</div>
		</div>

		<div id="editor">Connecting...</div>
		<script src="index_files/ace_002.txt" type="text/javascript" charset="utf-8"></script>
		<script src="index_files/mode-coffee.txt" type="text/javascript" charset="utf-8"></script>
    <script src="index_files/bcsocket.txt"></script>
		<script src="index_files/share.txt"></script>
		<script src="index_files/ace.txt"></script>
		<script>
	var doc = null;
	var editor;
